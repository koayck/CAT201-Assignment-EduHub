    ...
    <div className="bg-white">
      <Section>
        <div className="flex flex-col justify-center max-md:items-center">
          ...
          <div
            className="mt-12 md:mt-14 flex flex-wrap max-lg:justify-center gap-6 md:gap-x-24 md:gap-y-6 max-sm:mx-4 max-md:mx-10"
            data-aos="zoom-in-up"
            data-aos-delay="700"
          >
            <div className="flex flex-col basis-2/5 grow">
              ...
              <p className="max-md:hidden mt-6 text-grey-600">
                ...
                topics, ensuring comprehensive skill development for our
                students
              </p>
            </div>
            <div className="flex flex-col basis-2/5 grow">
